...
\node [mybox] (box){%
    ...
    \frac{P}{\rho} = P V_s = RT
    $$
donde $P$ es la presi\'on absoluta del gas, $\rho=1/V_s$ es la densidad o el volumen espec\'ifico, $T$ es la temperatura absoluta, y $R$ es la constante del gas $R=\frac{8312}{M}$ ($\frac{N.m}{kg. ^oK}$) en S.I. y  $R=\frac{1545}{M}$ ($\frac{lb.pie}{lb_m . ^oR}$) en sistema Ingl\'es, donde $M$ es la masa molecular del gas. 
    \begin{itemize}
